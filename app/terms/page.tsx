            ...
            <main className="flex-grow p-4 sm:p-6 md:p-12 lg:p-16">
              <div className="bg-white dark:bg-surface-dark border border-gray-300 dark:border-white/10 rounded-2xl p-8 sm:p-12">
                ...
                <div className="space-y-8 text-gray-600 dark:text-gray-400">
                  ...
                  <section>
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">3. Authorized Use Only</h2>
                    <p>
                  ...
                  <section>
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">6. Account Termination</h2>
                    <p>
